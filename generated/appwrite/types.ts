...
export type QueryBuilder<T> = {
  equal: <K extends keyof any>(field: K, value: any) => string;
  notEqual: <K extends keyof any>(field: K, value: any) => string;
  lessThan: <K extends keyof any>(field: K, value: any) => string;
  lessThanEqual: <K extends keyof any>(field: K, value: any) => string;
  greaterThan: <K extends keyof any>(field: K, value: any) => string;
  greaterThanEqual: <K extends keyof any>(field: K, value: any) => string;
  contains: <K extends keyof any>(field: K, value: any) => string;
  search: <K extends keyof any>(field: K, value: string) => string;
  isNull: <K extends keyof any>(field: K) => string;
  isNotNull: <K extends keyof any>(field: K) => string;
  startsWith: <K extends keyof any>(field: K, value: string) => string;
  endsWith: <K extends keyof any>(field: K, value: string) => string;
  between: <K extends keyof any>(field: K, start: any, end: any) => string;
